...
description: >
  ...
  and packaging oddities. Use when packaging data kits, DataPackageKitDefinition, DMOs, data streams,
  or Data Cloud metadata for AppExchange or managed package distribution.
---
